...
os.system("omxplayer --win 0,0,400,480 --no-keys --no-osd --live 'http://192.168.1.113:8000/stream.mjpg' &")
...
while(gui.is_alive()):
	...
	except Exception as e: print(e) #silence watchdog errors
	try:
		gui.update()
	except Exception as e: print(e) #silence errors from user
	try:
	...
	except Exception as e: print(e) #silence errors from wifi
	time.sleep(0.01)
